...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title"> Zwe Zay Nyi
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">
                Junior Full Stack Developer from Thailand and
                contributing to the development of dynamic web applications,
                gaining hands-on experience in all stages of the software development lifecycle.
            </p>
